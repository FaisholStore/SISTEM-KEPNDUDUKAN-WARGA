    ...
    <div class="card-body">
        <div class="table-responsive">
            <div>
                ...
                <a href="?page=laporan/testing.php" class="btn btn-primary ">
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <?php
              $no = 1;
			  $sql = $koneksi->query("SELECT p.id_pend, p.nik, p.nama, p.jekel, p.kelurahan, p.rt, p.rw, a.id_kk, k.no_kk, k.kepala FROM 
